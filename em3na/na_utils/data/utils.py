...
from em3na.na_utils.data import protein_constants, nucleotide_constants, rigid_utils as ru
...
COMPLEX_FEATURE_CONCAT_MAP = {
    ...
    # MOD
    ("alt_torsion_angles_sin_cos", "alt_torsion_angles_sin_cos", "alt_torsion_angles_sin_cos", 1): 10, 
    ("torsion_angles_mask", "torsion_angles_mask", "torsion_angles_mask", 1): 10, 
}
...
def pad_feats(raw_feats, max_len, use_torch=False):
    # MOD pad different feats according to different type
    padded_feats = {
...
def parse_chain_feats(chain_feats, scale_factor=1., center=False):
...
def parse_chain_feats_pdb(chain_feats, molecule_constants, molecule_backbone_atom_name, scale_factor=1.0, center=False):
    ...
    # MOD
    #chain_feats["res_idx"] = chain_feats["residue_index"]
    return chain_feats 
...
def parse_complex_feats(complex_feats, scale_factor=1.0, center=False):
    ...
    if center:
        ...
        centered_pos = complex_feats["atom_positions"]
