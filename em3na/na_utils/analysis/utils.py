...
from em3na.na_utils.data import complex
...
def write_complex_to_pdbs(
    ...
    **kwargs,
    ...
    na_save_path = str(Path(save_path).parent / (os.path.basename(save_path)))
