...
def edge_rope(q, k, edge_pos, freq_base=1000):
    ...
    q_r = einops.rearrange(q, "... n k h d -> ... (n k) h d", n=n, k=nk, h=h, d=d)
    k_r = einops.rearrange(k, "... n k h d -> ... (n k) h d", n=n, k=nk, h=h, d=d)
    edge_pos_r = einops.rearrange(edge_pos, "... n k d -> ... (n k) d", n=n, k=nk, d=3)
    
    q_r, k_r = node_rope(q_r, k_r, edge_pos_r)

    q = einops.rearrange(q_r, "... (n k) h d -> ... n k h d", n=n, k=nk, h=h, d=d)
    k = einops.rearrange(k_r, "... (n k) h d -> ... n k h d", n=n, k=nk, h=h, d=d)
